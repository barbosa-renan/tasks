...
public class CreateTaskListTests
{
    ...
    public void InvalidCreateCommand_TryValidate_ShouldReturnErrors()
    {
        // Arrange
    ...
    [Fact(DisplayName = "DADO um título inválido, QUANDO validar o comando, DEVE retornar erro de 256 caracteres")]
    [Trait("Application", "Create - TaskList")]
    public void InvalidCreateCommand_TryValidateTitle_ShouldReturnErrors()
    {
        // Arrange
        var command = new CreateTaskListCommand
        {
